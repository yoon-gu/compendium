...
\begin{figure}[H]
    ...
    \end{tabular}
    \caption{Sample from MDLM \citep{sahoo2024simple} of length $L=1024$ and $T=5$K diffusion steps. The generative perplexity of this sample under GPT2-Large is 69.26 and its entropy is 5.6.}
    \label{mdlm-samples}
\end{figure}
