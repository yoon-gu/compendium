...
\end{center}
\caption{\label{tab:squad_results} SQuAD 1.1 결과. BERT 앙상블은 서로 다른 사전학습 체크포인트와 파인튜닝 시드를 사용하는 7개 시스템의 앙상블이다.}
\end{table}
...
\end{center}
\caption{\label{tab:squad2_results} SQuAD 2.0 결과. BERT를 구성요소로 사용하는 엔트리는 제외했다.}
\end{table}
