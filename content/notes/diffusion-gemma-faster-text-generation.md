...
<video controls autoplay loop muted playsinline preload="metadata" title="Hugging Face DiffusionGemma text-to-3D SVG demo" style="display:block; width:100%; max-width:100%; max-height:70vh; height:auto; object-fit:contain; margin:1rem auto;">
...
<video controls autoplay loop muted playsinline preload="metadata" title="DiffusionGemma Process" style="display:block; width:100%; max-width:100%; max-height:70vh; height:auto; object-fit:contain; margin:1rem auto;">
